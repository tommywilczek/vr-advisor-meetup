...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        // TOMMY'S CUSTOM CODE START
        //public GameObject avatarPrefab;

        //public GameObject cameraRig;
        // TOMMY'S CUSTOM CODE END
        ...
        public override void OnJoinedRoom()
        {
            ...
            //int randomX = randomX.Range(-4, 4);
            //int randomZ = randomX.Range(-4, 4);
            //GameObject go = PhotonNetwork.Instantiate(avatarPrefab.name, new Vector3(randomX, 2, randomZ), Quaternion.identity, 0);

            //target = cameraRig.transform;

            //target.transform.position = new Vector3(randomX, 2, randomZ);
            //Debug.log("Instantiated Avatar Prefab");
        }
    }
